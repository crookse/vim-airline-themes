...
" Normal mode                                    " fg             & bg
let s:N1 = [ '#005f00' , '#afd700' , 232 , 148 ] " darkestgreen   & brightgreen
let s:N2 = [ '#9e9e9e' , '#303030' , 247 , 236 ] " gray8          & gray2
let s:N3 = [ '#ffffff' , '#121212' , 232 , 24  ] " white          & gray4

" Insert mode                                    " fg             & bg
let s:I1 = [ '#005f5f' , '#ffffff' , 23  , 231 ] " darkestcyan    & white
let s:I2 = [ '#5fafd7' , '#0087af' , 74  , 31  ] " darkcyan       & darkblue
let s:I3 = [ '#87d7ff' , '#005f87' , 117 , 25  ] " mediumcyan     & darkestblue
...
let s:R1 = [ '#005f00' , '#afd700' , 231 , 160 ] " darkestgreen   & brightgreen
let s:R2 = [ '#9e9e9e' , '#303030' , 247 , 236 ] " gray8          & gray2
let s:R3 = [ '#ffffff' , '#121212' , 231 , 160 ] " white          & gray4
...
let g:airline#themes#powerlineish#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
